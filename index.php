...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
								...
								<li><a href="https://google.com/" class="fa fa-google-plus icon-border googleplus"> </a></li>
							</ul>
			</div>
			<div class="contact-bnr-w3-agile">
				<ul>

					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:sibi24sibi.2@gmail.com">double.s.hotel@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9823336952</li>
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Double-<span>S</span><p class="logo_w3l_agile_caption">Your Dream Resort</p></a></h1>
				</div>
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p> You'll love all the amenities we offer. </p>
											<p> You'll love all the amenities we offer. </p>
										</div>
		          </div>
		   	<div cOREass="clearfix"> </div>
    </div>
</div>
 	<!-- //about -->
<!--sevices-->
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>ABDUL BASITH</h4>
                    <span>PERUNGULAM</span>
							<span>Manager</span>
							<p>HI HOW ARE YOU THIS IS OUR NEW HIGH SUITE HOTEL.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+917200136276</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:tawfee2381@gmail.com">tawfee2381@gmail.com</a></p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 HOTEL SITE . All Rights Reserved | Brought To You by <a href="https://www/">RAYMON H</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
